<?php
	...
	$query= 'SELECT TransactionID, CustomerID FROM transaction_information WHERE Trans_Init_Date BETWEEN "2017-01-01" AND "2019-01-01"';
...
<body>
    ...
    <h3> Transactions that have occured between 2017-2019 </h3>
